...
public class Dashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Organizer_id", "Event Name", "Description", "Location ", "Remaining Seats", "Date", "Booked"
            }
        ) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       if(jTable1.getSelectedRowCount() == 1){
           ...
           String event_name = jTable1.getModel().getValueAt(row, 1).toString();
           
           new Db().book_by_name(event_name);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        Db db = new Db();
        int id = db.fetch_from_session();
        if (db.fetch_current_user_status(id) == true){
            this.dispose();
            new AddProgram().setVisible(true);
            
        }else if (db.fetch_current_user_status(id) == false){
            JOptionPane.showMessageDialog(null, "Sorry , you are not authorized to add new event");
        }
